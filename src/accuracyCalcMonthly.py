...
os.makedirs('Visualisation/MonthlyAQIComparisons', exist_ok=True)
...
for month, group in data.groupby('month'):
    ...
    plt.tight_layout()
    plt.savefig(f'Visualisation/MonthlyAQIComparisons/{month}.png')
    plt.close()


accuracy_df = pd.DataFrame(accuracy_data)
accuracy_df.to_csv('Data/FinalData/aqiMonthlyAccuracy.csv', index=False)

print("Monthly AQI comparison images saved in 'visualisation' folder.")
print("Monthly accuracy data saved to 'Data/FinalData/aqiMonthlyAccuracy.csv'.")
