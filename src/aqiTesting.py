...
os.makedirs('Visualisation/DailyAQIComparisons', exist_ok=True)
...
for day, group in data.groupby('day'):
    ...
    plt.tight_layout()
    plt.savefig(f'Visualisation/DailyAQIComparisons/{day}.png')
    plt.close()

print("Daily AQI comparison images saved in 'Visualisation/DailyAQIComparisons' folder.")
