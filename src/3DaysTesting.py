...
data = pd.read_csv('Data/FinalData/data.csv')
...
predictions_df.to_csv('Data/FinalData/aqiPredictionData.csv', index=False)

print("Predictions for the next 3 days saved to 'Data/FinalData/aqiPredictionData.csv'.")
